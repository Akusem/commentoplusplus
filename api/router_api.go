...
func apiRouterInit(router *mux.Router) error {
	...
	router.HandleFunc("/api/comment/label/new", commentLabelNewHandler).Methods("POST")
	router.HandleFunc("/api/comment/label/delete", commentLabelDeleteHandler).Methods("POST")
	...
	router.HandleFunc("/api/label/edit", labelEditHandler).Methods("POST")
	router.HandleFunc("/api/label/delete", labelDeleteHandler).Methods("POST")
	router.HandleFunc("/api/label/listAll", labelListAllHandler).Methods("POST")

...
var errorNoSuchLabel = errors.New("No such label.")
var errorCannotLinkLabel = errors.New("Cannot add label to this comment.")
var errorCannotRemoveCommentLabel = errors.New("Cannot remove label from this comment.")
